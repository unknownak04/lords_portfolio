...
const Experience = () => {
  ...
  const experience = {
    ...
    duration: "October 2023",
    location: "Remote",
    description: "Completed an intensive web development internship focusing on modern technologies and best practices.",
    responsibilities: [
      "Built responsive web interfaces with HTML, CSS, and JavaScript",
      "Developed React components for dynamic user interactions",
      "Worked with Node.js and Express.js for backend development",
      "Integrated MongoDB for data management solutions"
    ],
    technologies: ["HTML", "CSS", "JavaScript", "React.js", "Node.js", "Express.js", "MongoDB"]
  };
            ...
            <div className="bg-white border border-gray-200 rounded-lg p-6 sm:p-8 shadow-sm">
              <div className="flex items-start space-x-4">
                ...
                <div className="flex-1">
                  ...
                  <div className="mb-4">
                    <h5 className="text-sm font-semibold text-gray-700 mb-2">Key Activities:</h5>
                    <ul className="space-y-2">
                      {experience.responsibilities.map((responsibility, index) => (
                        <li key={index} className="text-sm text-gray-600 flex items-start">
                  ...
                  <div>
                    ...
                    <div className="flex flex-wrap gap-2">
                      {experience.technologies.map((tech, index) => (
                        <span 
                          key={index} 
                          className="px-3 py-1 bg-orange-50/50 text-orange-700 text-xs rounded-full border border-orange-200/50 shadow-sm"
                        >
                          {tech}
                        </span>
                      ))}
